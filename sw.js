...
const CACHE_NAME = 'pam-desktop-2026-05-27-b76'; // b76: Dual-Outlook: zweiter Konto-Slot (f.braun@ddmbraun.de), Button 📨 f.B, automatische Fallback-Suche Token2 // b74: Outlook-Fix: Token-Refresh auch wenn msToken=null (nach Reload), Auto-Load im Popup auch bei gespeichertem MSAL-Account // b73: tDokOrdner-Feld (01_Dokumente-Ordner) // b72: UI-Fix Freier-Termin-Badge, Auftrag-planen Schriftgröße, Auftrag-planen auf Karte // b70: VBS nasGrand zwei-Ebenen-Suche
const PRECACHE = [
